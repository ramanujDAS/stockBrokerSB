...
public class TradeDao {
    ...
    public TradeDao(long tradeId, TradeType tradeType, long buyerOrderId, long sellerOrderId, StockSymbol stockSymbol, int quantity, double price, long timeStamp) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TradeDao )) return false;
        TradeDao trades = (TradeDao) o;
